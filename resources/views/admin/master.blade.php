...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" style="background: #fff;">

    <!-- BEGIN: Main Menu-->
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="../public" target="_blank">
                        
                        <img src="img/Keroles OnTrack-Logo-2.png" style="width:150px; height:90px;" alt="">
                    </a></li> <br>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a href="issue"><span class="menu-item" data-i18n="Support Issue">Support Issue</span></a></li>
                <li class="nav-item has-sub"><a href="modules"><span class="menu-title">modules</span></a>
                      <ul class="menu-content">
                          <li class="is-shown"><a href="security"><span class="menu-item" data-i18n="Security">Security</span></a></li>
                          <li class="is-shown"><a href="safety"><span class="menu-item" data-i18n="Safety">Safety</span></a></li>
                          <li class="is-shown"><a href="mep"><span class="menu-item" data-i18n="MEP">MEP</span></a></li>
                          <li class="is-shown"><a href="house"><span class="menu-item" data-i18n="House Keeping">House Keeping</span></a></li>
                      </ul>
              
                  </li>
                  <li class="nav-item"><a href="supporting"><span class="menu-item" data-i18n="Support Issue">Support</span></a></li>
                  <li class="nav-item has-sub"><a href="#"><span class="menu-title">Company Data</span></a>
                    <ul class="menu-content">
                        <li class="is-shown"><a href="company"><span class="menu-item" data-i18n="Security">Basic Data</span></a></li>
                        <li class="is-shown"><a href="structure"><span class="menu-item" data-i18n="Safety">Company Structure</span></a></li>
